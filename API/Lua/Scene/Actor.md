...
- C++ related class: [`OvCore::ECS::Actor`](/Sources/OvCore/include/OvCore/ECS/Actor.h)
...
|GetSkinnedMeshRenderer|`Actor`:&nbsp;instance<br>|`SkinnedMeshRenderer`|Returns the SkinnedMeshRenderer attached to this actor (if any)|
...
|AddSkinnedMeshRenderer|`Actor`:&nbsp;instance<br>|`SkinnedMeshRenderer`|Adds a SkinnedMeshRenderer component to the actor and returns it|
...
|RemovePostProcessStack|`Actor`:&nbsp;instance<br>|`boolean`|Removes the PostProcessStack component from the actor (Returns true of success)|
|RemoveReflectionProbe|`Actor`:&nbsp;instance<br>|`boolean`|Removes the ReflectionProbe component from the actor (Returns true of success)|
|RemoveSkinnedMeshRenderer|`Actor`:&nbsp;instance<br>|`boolean`|Removes the SkinnedMeshRenderer component from the actor (returns `true` on success)|
