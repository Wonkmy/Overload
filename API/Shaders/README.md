...
## 3.5. Engine Features
Some feature are declared as `#engine_feature`, which means that they won't be exposed to the user in the material editor, and should be controlled by the engine.
